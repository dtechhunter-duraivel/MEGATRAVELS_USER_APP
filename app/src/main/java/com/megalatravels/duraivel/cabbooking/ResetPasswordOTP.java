...
public class ResetPasswordOTP extends AppCompatActivity {
    ...
    {
        String url = "http://bhashsms.com/api/sendmsg.php?user=megala&pass=******&sender=MEGALA&phone="+phon+"&text=Your%20One Time%20Verification%20Code%20to%20Reset%20Password%20is:"+otpv+"&priority=ndnd&stype=normal";
